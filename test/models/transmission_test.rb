...
class TransmissionTest <  ActiveSupport::TestCase
  ...
  test "the distortion level is relative to the message's round" do
    ...
    assert_empty transmission.distortion_level              # … but the message relates to the 1st, where there is no distortion
  end
end
